...
- **3種類の受信モード** — プレーンテキスト / CSV 数値 / バイナリパケット
...
| プラットフォーム | ファイル |
|---|---|
| macOS (Apple Silicon) | `SerialMonitor-1.1.1-macOS.dmg` |
| Windows (x64) | `SerialMonitor-1.1.1-Windows.exe` |
...
ISCC.exe /DMyAppVersion=1.1.1 installer.iss
```
